...
public class ResponseManager implements Manager {
	...
	public void sendResponse(Response response) throws Exception{
		try{
			...
			System.out.println("Error in sendResponse in responseManager");
			throw ex;
		}
	}
	...
	public void sendJson(Response response) throws Exception{
		try{
			...
			System.out.println("Error in sendJson in responseManager");
			throw ex;
		}
	}
	...
	public void sendJsp(Response response) throws Exception{
		try{
			...
			System.out.println("Error in sendJsp in responseManager");
			throw ex;
		}
	}
}